...
var file_matter_proto_rawDesc = []byte{
	...
	0x22, 0xde, 0x01, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x61, 0x69, 0x6c, 0x53, 0x65, 0x6e,
	...
	0x64, 0x22, 0x7a, 0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x53, 0x65, 0x6e, 0x64,
...
var file_matter_proto_depIdxs = []int32{
	...
	114, // 95: trade.MessageSenders.message_senders:type_name -> trade.MessageSender
	66,  // 96: trade.Message.metadata:type_name -> trade.KV
	66,  // 97: trade.Message.template_var:type_name -> trade.KV
	119, // 98: trade.Message.template:type_name -> trade.TextTemplate
	117, // 99: trade.Message.actions:type_name -> trade.MessageAction
	116, // 100: trade.Messages.messages:type_name -> trade.Message
	119, // 101: trade.TextTemplates.templates:type_name -> trade.TextTemplate
	121, // 102: trade.ImageFile.thumbnails:type_name -> trade.ImageFile
