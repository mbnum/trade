...
var file_matter_proto_rawDesc = []byte{
	...
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xcf, 0x0b,
	...
	0x69, 0x64, 0x18, 0x27, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x6f, 0x73, 0x49, 0x64, 0x22,
	0x96, 0x01, 0x0a, 0x0b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12,
	...
	0x0d, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x27,
	0x0a, 0x0f, 0x73, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xb2, 0x01, 0x0a, 0x06, 0x4f, 0x72, 0x64,
	...
	0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x2c, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69,
	0x63, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x74, 0x72, 0x61, 0x64, 0x65,
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x52, 0x07, 0x6d, 0x65,
	0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x26, 0x0a, 0x0f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x75, 0x6d, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x75, 0x6d, 0x22, 0x9a, 0x06,
	...
	0x61, 0x74, 0x65, 0x48, 0x6f, 0x75, 0x72, 0x54, 0x6f, 0x12, 0x27, 0x0a, 0x0f, 0x69, 0x6e, 0x63,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x12, 0x2c, 0x0a, 0x12,
	...
	0x65, 0x64, 0x53, 0x65, 0x6c, 0x6c, 0x65, 0x72, 0x49, 0x64, 0x22, 0xe4, 0x02, 0x0a, 0x12, 0x4f,
	...
	0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xb6, 0x02, 0x0a, 0x0e, 0x4f, 0x72, 0x64,
...
var file_matter_proto_depIdxs = []int32{
	...
	14, // 22: trade.Orders.orders:type_name -> trade.Order
	15, // 23: trade.Orders.metrics:type_name -> trade.OrderMetric
	54, // 24: trade.OrderChangeRequest.ctx:type_name -> trade.Context
	20, // 25: trade.OrderChangeRequest.phone_call:type_name -> trade.PhoneCall
	21, // 26: trade.OrderChangeRequest.mail:type_name -> trade.Mail
	22, // 27: trade.OrderChangeRequest.sms:type_name -> trade.Sms
	19, // 28: trade.OrderChangeRequest.lead:type_name -> trade.Lead
	18, // 29: trade.OrderChangeLog.in:type_name -> trade.OrderChangeRequest
	14, // 30: trade.OrderChangeLog.src:type_name -> trade.Order
	14, // 31: trade.OrderChangeLog.dst:type_name -> trade.Order
	29, // 32: trade.Pipeline.action:type_name -> trade.OrderAction
	29, // 33: trade.Pipeline.actions:type_name -> trade.OrderAction
	27, // 34: trade.Pipeline.condition:type_name -> trade.PipelineCondition
	26, // 35: trade.Pipelines.pipelines:type_name -> trade.Pipeline
	29, // 36: trade.OrderAction.next_actions:type_name -> trade.OrderAction
	30, // 37: trade.OrderAction.ship:type_name -> trade.OrderActionShip
	31, // 38: trade.OrderAction.pay:type_name -> trade.OrderActionPay
	33, // 39: trade.OrderAction.contact:type_name -> trade.OrderActionContact
	34, // 40: trade.OrderAction.booking:type_name -> trade.OrderActionBooking
	36, // 41: trade.OrderAction.call:type_name -> trade.OrderActionCall
	37, // 42: trade.OrderAction.email:type_name -> trade.OrderActionEmail
	38, // 43: trade.OrderAction.update_customer:type_name -> trade.OrderActionUpdateCustomer
	42, // 44: trade.OrderAction.assign:type_name -> trade.OrderActionAssign
	39, // 45: trade.OrderAction.cancel:type_name -> trade.OrderActionCancel
	40, // 46: trade.OrderAction.confirm:type_name -> trade.OrderActionConfirm
	41, // 47: trade.OrderAction.feedback:type_name -> trade.OrderActionFeedback
	43, // 48: trade.OrderAction.note:type_name -> trade.OrderActionNote
	44, // 49: trade.OrderAction.sms:type_name -> trade.OrderActionSms
	45, // 50: trade.OrderAction.campaign:type_name -> trade.OrderActionCampaign
	46, // 51: trade.OrderAction.conversation:type_name -> trade.OrderActionConversation
	47, // 52: trade.OrderAction.comment:type_name -> trade.OrderActionComment
	49, // 53: trade.Product.other_variants:type_name -> trade.Product
	52, // 54: trade.Product.props:type_name -> trade.KV
	25, // 55: trade.Product.tax:type_name -> trade.Tax
	49, // 56: trade.Products.products:type_name -> trade.Product
	52, // 57: trade.ProductsRequest.props:type_name -> trade.KV
	56, // 58: trade.Context.account:type_name -> trade.Account
	57, // 59: trade.Context.member:type_name -> trade.AccountMember
	58, // 60: trade.Context.web_browser:type_name -> trade.WebBrowser
	55, // 61: trade.Context.reqruns:type_name -> trade.Reqrun
	57, // 62: trade.AccountMember.others:type_name -> trade.AccountMember
	73, // 63: trade.AccountMember.address:type_name -> trade.Address
	64, // 64: trade.UserAction.email:type_name -> trade.UserActionEmail
	73, // 65: trade.Addresses.addresses:type_name -> trade.Address
	74, // 66: trade.Address.ghn:type_name -> trade.GHNAddress
	73, // 67: trade.Address.ghtk:type_name -> trade.Address
	73, // 68: trade.IntegratedShipping.address:type_name -> trade.Address
