...
var file_matter_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x61, 0x74, 0x22, 0xcc, 0x03, 0x0a, 0x07, 0x41,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x85, 0x02, 0x0a, 0x0a, 0x57, 0x65,
	...
	0x70, 0x6c, 0x61, 0x74, 0x65, 0x49, 0x64, 0x42, 0x18, 0x5a, 0x16, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_matter_proto_msgTypes = make([]protoimpl.MessageInfo, 112)
var file_matter_proto_goTypes = []interface{}{
	...
	(*SendGridContent)(nil),              // 105: trade.SendGridContent
	(*SendGridEmail)(nil),                // 106: trade.SendGridEmail
	(*SendGridPersonalization)(nil),      // 107: trade.SendGridPersonalization
	(*SendMailSendGridReq)(nil),          // 108: trade.SendMailSendGridReq
	nil,                                  // 109: trade.Order.FieldsEntry
	nil,                                  // 110: trade.Account.KvmEntry
	nil,                                  // 111: trade.SendGridPersonalization.DynamicTemplateDataEntry
}
var file_matter_proto_depIdxs = []int32{
	...
	109, // 24: trade.Order.fields:type_name -> trade.Order.FieldsEntry
	...
	108, // 36: trade.OrderChangeRequest.mail_send_grid:type_name -> trade.SendMailSendGridReq
	27,  // 37: trade.OrderChangeLog.in:type_name -> trade.OrderChangeRequest
	17,  // 38: trade.OrderChangeLog.src:type_name -> trade.Order
	17,  // 39: trade.OrderChangeLog.dst:type_name -> trade.Order
	32,  // 40: trade.OrderChangeLogs.logs:type_name -> trade.OrderChangeLog
	39,  // 41: trade.Pipeline.action:type_name -> trade.OrderAction
	39,  // 42: trade.Pipeline.actions:type_name -> trade.OrderAction
	37,  // 43: trade.Pipeline.condition:type_name -> trade.PipelineCondition
	36,  // 44: trade.Pipelines.pipelines:type_name -> trade.Pipeline
	39,  // 45: trade.OrderAction.next_actions:type_name -> trade.OrderAction
	40,  // 46: trade.OrderAction.ship:type_name -> trade.OrderActionShip
	41,  // 47: trade.OrderAction.pay:type_name -> trade.OrderActionPay
	43,  // 48: trade.OrderAction.contact:type_name -> trade.OrderActionContact
	44,  // 49: trade.OrderAction.booking:type_name -> trade.OrderActionBooking
	46,  // 50: trade.OrderAction.call:type_name -> trade.OrderActionCall
	47,  // 51: trade.OrderAction.email:type_name -> trade.OrderActionEmail
	48,  // 52: trade.OrderAction.update_customer:type_name -> trade.OrderActionUpdateCustomer
	52,  // 53: trade.OrderAction.assign:type_name -> trade.OrderActionAssign
	49,  // 54: trade.OrderAction.cancel:type_name -> trade.OrderActionCancel
	50,  // 55: trade.OrderAction.confirm:type_name -> trade.OrderActionConfirm
	51,  // 56: trade.OrderAction.feedback:type_name -> trade.OrderActionFeedback
	53,  // 57: trade.OrderAction.note:type_name -> trade.OrderActionNote
	54,  // 58: trade.OrderAction.sms:type_name -> trade.OrderActionSms
	55,  // 59: trade.OrderAction.campaign:type_name -> trade.OrderActionCampaign
	56,  // 60: trade.OrderAction.conversation:type_name -> trade.OrderActionConversation
	57,  // 61: trade.OrderAction.comment:type_name -> trade.OrderActionComment
	59,  // 62: trade.Product.other_variants:type_name -> trade.Product
	62,  // 63: trade.Product.props:type_name -> trade.KV
	35,  // 64: trade.Product.tax:type_name -> trade.Tax
	59,  // 65: trade.Products.products:type_name -> trade.Product
	62,  // 66: trade.ProductsRequest.props:type_name -> trade.KV
	66,  // 67: trade.Context.account:type_name -> trade.Account
	67,  // 68: trade.Context.web_browser:type_name -> trade.WebBrowser
	65,  // 69: trade.Context.reqruns:type_name -> trade.Reqrun
	66,  // 70: trade.Account.others:type_name -> trade.Account
	110, // 71: trade.Account.kvm:type_name -> trade.Account.KvmEntry
	73,  // 72: trade.UserAction.email:type_name -> trade.UserActionEmail
	82,  // 73: trade.Addresses.addresses:type_name -> trade.Address
	83,  // 74: trade.Address.ghn:type_name -> trade.GHNAddress
	82,  // 75: trade.Address.ghtk:type_name -> trade.Address
	82,  // 76: trade.IntegratedShipping.address:type_name -> trade.Address
	89,  // 77: trade.ListRequest.key:type_name -> trade.Key
	66,  // 78: trade.Agents.agents:type_name -> trade.Account
	26,  // 79: trade.AssignmentAgent.condition:type_name -> trade.OrdersRequest
	100, // 80: trade.AssignmentUnixHour.agents:type_name -> trade.AssignmentAgent
	100, // 81: trade.Assignment.capacity:type_name -> trade.AssignmentAgent
	101, // 82: trade.Assignment.actual:type_name -> trade.AssignmentUnixHour
	66,  // 83: trade.AgentGroup.agents:type_name -> trade.Account
	103, // 84: trade.AgentGroups.agent_groups:type_name -> trade.AgentGroup
	106, // 85: trade.SendGridPersonalization.to:type_name -> trade.SendGridEmail
	111, // 86: trade.SendGridPersonalization.dynamic_template_data:type_name -> trade.SendGridPersonalization.DynamicTemplateDataEntry
	107, // 87: trade.SendMailSendGridReq.personalizations:type_name -> trade.SendGridPersonalization
	106, // 88: trade.SendMailSendGridReq.from:type_name -> trade.SendGridEmail
	105, // 89: trade.SendMailSendGridReq.content:type_name -> trade.SendGridContent
