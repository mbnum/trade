...
var file_matter_proto_rawDesc = []byte{
	...
	0x8c, 0x02, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x70,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x3b, 0x0a, 0x0b, 0x4c, 0x69, 0x73,
	...
	0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x42, 0x18, 0x5a, 0x16, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_matter_proto_msgTypes = make([]protoimpl.MessageInfo, 88)
var file_matter_proto_goTypes = []interface{}{
	...
	(*Address)(nil),                   // 72: trade.Address
	(*GHNAddress)(nil),                // 73: trade.GHNAddress
	(*IPAddress)(nil),                 // 74: trade.IPAddress
	(*Credit)(nil),                    // 75: trade.Credit
	(*BusinessHour)(nil),              // 76: trade.BusinessHour
	(*Service)(nil),                   // 77: trade.Service
	(*Campaign)(nil),                  // 78: trade.Campaign
	(*Key)(nil),                       // 79: trade.Key
	(*Webhook)(nil),                   // 80: trade.Webhook
	(*IntegratedShipping)(nil),        // 81: trade.IntegratedShipping
	(*ProductFeed)(nil),               // 82: trade.ProductFeed
	(*ProductCollection)(nil),         // 83: trade.ProductCollection
	(*Bill)(nil),                      // 84: trade.Bill
	(*OrderComment)(nil),              // 85: trade.OrderComment
	(*ShopeeShop)(nil),                // 86: trade.ShopeeShop
	(*ListRequest)(nil),               // 87: trade.ListRequest
}
var file_matter_proto_depIdxs = []int32{
	...
	72, // 62: trade.AccountMember.address:type_name -> trade.Address
	64, // 63: trade.UserAction.email:type_name -> trade.UserActionEmail
	73, // 64: trade.Address.ghn:type_name -> trade.GHNAddress
	72, // 65: trade.Address.ghtk:type_name -> trade.Address
	72, // 66: trade.IntegratedShipping.address:type_name -> trade.Address
