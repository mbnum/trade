...
var file_what_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x42, 0x18, 0x5a, 0x16, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_what_proto_goTypes = []interface{}{
	...
	(*Messages)(nil),       // 8: trade.Messages
	(*TextTemplates)(nil),  // 9: trade.TextTemplates
}
var file_what_proto_depIdxs = []int32{
	...
	8,  // 15: trade.Textme.React:output_type -> trade.Messages
	4,  // 16: trade.Textme.ReadTextTemplate:output_type -> trade.TextTemplate
	9,  // 17: trade.Textme.ListTextTemplates:output_type -> trade.TextTemplates
